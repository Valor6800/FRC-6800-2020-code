...
//     public:
//     Trajectories();
const nt::NetworkTableEntry m_startPos;
//     private:
// };
...
const double starto = m_startPos.GetDouble(0);//4.88_m;
...
//Offensive/Defensive 10 ball auto
    ...
    const std::vector<frc::Pose2d> Auto3Traj1Poses = {frc::Pose2d(0_m,0_m,frc::Rotation2d(0_deg)),frc::Pose2d(3.7_m,(-7.64_m  + units::length::meter_t(m_startPos.GetDouble(0))),frc::Rotation2d(-60_deg))};
        //return
    const std::vector<frc::Pose2d> Auto3Traj2Poses = {Auto3Traj1Poses[1],frc::Pose2d(0_m,(-2.69_m + units::length::meter_t(m_startPos.GetDouble(0))),frc::Rotation2d(0_deg))};
    //Balls on the bar
    const std::vector<frc::Pose2d> Auto3Traj3Poses = {Auto3Traj2Poses[1],frc::Pose2d(3.3_m,(-3.04_m + units::length::meter_t(m_startPos.GetDouble(0))),frc::Rotation2d(-35_deg))};
    //ball pos: 2.9,0.5    3.3,0.7
        //return
    const std::vector<frc::Pose2d> Auto3Traj4Poses = {Auto3Traj3Poses[1],frc::Pose2d(1.5_m,(-kCenterline + units::length::meter_t(m_startPos.GetDouble(0))),frc::Rotation2d(0_deg))};
    //3 Trench balls         x's 23ft 5in(7.134m) 25ft 8in(7.823)        2.44m to wall tip of triangle
    const std::vector<frc::Translation2d> Auto3Traj5Translations = {frc::Translation2d(2.2_m,(-kCenterline + units::length::meter_t(m_startPos.GetDouble(0))))};  //center line needs to be adjusted
    const std::vector<frc::Pose2d> Auto3Traj5Poses = {frc::Pose2d(Auto3Traj4Poses[1]),frc::Pose2d(5_m,(-kCenterline + units::length::meter_t(m_startPos.GetDouble(0))),frc::Rotation2d(0_deg))};
    //ShootSpot
    const std::vector<frc::Pose2d> Auto3Traj6Poses = {Auto3Traj5Poses[1] ,frc::Pose2d(4_m,(-kCenterline + units::length::meter_t(m_startPos.GetDouble(0)) -0.2_m),frc::Rotation2d(15_deg))};