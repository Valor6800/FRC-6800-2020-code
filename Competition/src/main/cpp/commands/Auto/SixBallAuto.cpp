...
SixBallAuto::SixBallAuto() {
    ...
    trajectory2 = m_trajectories.GetAutosMap().at("SixBallAuto")[0].trajectory;
    ...
    trajectory3 = m_trajectories.GetAutosMap().at("SixBallAuto")[1].trajectory;
    ...
    AddCommands(
        frc2::SequentialCommandGroup(
            frc2::RunCommand( [&] { m_arm.SetArmPower(-0.5); }, {&m_arm} ).WithTimeout(0.25_s),
            frc2::RunCommand( [&] { m_arm.SetArmPower(1); }, {&m_arm} ).WithTimeout(1_s),
            frc2::RunCommand( [&] { m_arm.SetArmPower(0.5); }, {&m_arm} ).WithTimeout(2_s),
            frc2::InstantCommand( [&] { m_arm.SetArmPower(0); }, {&m_arm} ),
            //frc2::ParallelCommandGroup( frc2::RunCommand( [&] {m_shooter.SetShooterPower(0.7); } ).WithTimeout(2_s), std::move(ramseteCommand1)),
