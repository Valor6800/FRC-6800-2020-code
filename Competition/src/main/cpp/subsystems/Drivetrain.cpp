...
Drivetrain::Drivetrain() : boostMultiplier{0.5},
                           ...
                           kTrajectoryConfigCenterLineF{RamseteConstants::kMaxSpeed * 0.5, RamseteConstants::kMaxAcceleration * 0.5},
                           kTrajectoryConfigCenterLineR{RamseteConstants::kMaxSpeed * 0.5, RamseteConstants::kMaxAcceleration * 0.5},
